...
## A Reproducibility Problem in Parallel Inference
...
## Motivation: Portfolio Uncertainty Matters
...
**Core question:**
How uncertain are the inputs used for portfolio construction?
...
MCMC algorithms take samples:
$$
x^{(1)}, x^{(2)}, \dots, x^{(K)}
$$

from the unnormalized target density $\gamma(x)$
